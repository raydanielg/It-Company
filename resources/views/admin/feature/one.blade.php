                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <div class="photo-container">
                                    <a href="{{ asset('uploads/'.$feature_one_items->photo) }}" class="magnific"><img src="{{ asset('uploads/'.$feature_one_items->photo) }}" alt=""></a>
                                </div>
                            </div>
                            <div class="mb-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin_feature_one_item_element_delete',$item->id) }}" class="btn btn-danger btn-sm btn-block" onClick="return confirm('{{ __('Are you sure?') }}')"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                            ...
                            <div class="modal fade" id="edit_modal_{{ $loop->iteration }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('admin_feature_one_item_element_update',$item->id) }}" method="post">
                                                @csrf
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Heading') }}*</label>
